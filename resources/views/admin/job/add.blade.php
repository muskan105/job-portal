                ...
                <form method="POST" action="{{ route('admin.job.store') }}">
                    ...
                    <div class="max-w-xl">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" required autocomplete="title" />
                            <x-input-error :messages="$errors->get('title')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="company_name" :value="__('Company Name')" />
                            <x-text-input id="company_name" class="block mt-1 w-full" type="text" name="company_name" required autocomplete="company_name" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="requirement" class="block mt-1 w-full" type="text" name="requirement" required autocomplete="requirement" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="start_date" class="block mt-1 w-full" type="date" name="start_date" required autocomplete="start_date" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="end_date" class="block mt-1 w-full" type="date" name="end_date" required autocomplete="end_date" />
